...
import os
from local_farm.module.sqt import QApplication, QPalette, QColor, Qt
from local_farm.utils.const import LOCAL_FARM_RESOURCE_DIR
...
class MainApplication(QApplication):
    def __init__(self, *args, **kwargs):
        ...
        with open(os.path.join(LOCAL_FARM_RESOURCE_DIR, 'style.css')) as f:
            gui_style = f.read()
